...
public class Trendingmovietrailoradapter extends RecyclerView.Adapter<Trendingmovietrailoradapter.ViewHolder> {

      Context context;
      List<Trendingmovietrailormodel>list1;

    public Trendingmovietrailoradapter(Context context, List<Trendingmovietrailormodel> list) {
