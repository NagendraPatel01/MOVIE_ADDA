...
public class Searchmovietrailoradapter extends RecyclerView.Adapter<Searchmovietrailoradapter.ViewHolder> {

    Context context;
    List<Searchmovietrailormodel>list1;

    public Searchmovietrailoradapter(Context context, List<Searchmovietrailormodel> list1) {
