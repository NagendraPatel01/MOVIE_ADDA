...
public class TrendingtvshowsimilerAdapter extends RecyclerView.Adapter<TrendingtvshowsimilerAdapter.ViewHolder> {

    Context context;
    List <Trendingtvshowsimilermodel>list;

    public TrendingtvshowsimilerAdapter(Context context, List<Trendingtvshowsimilermodel> list) {
