...
import com.apk.movie1.Adapter.searchadapter.Searchpersonadapter;
...
public class SearchpersonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queue = Volley.newRequestQueue(SearchpersonActivity.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(SearchpersonActivity.this, RecyclerView.VERTICAL, false);
                        recycle.setLayoutManager(linearLayoutManager);
                        Searchpersonadapter searchpersonadapter = new Searchpersonadapter(SearchpersonActivity.this, list);
                        recycle.setAdapter(searchpersonadapter);
     ...
     /*   list = new ArrayList<>();
        ...
        Searchpersonadapter searchpersonadapter=new Searchpersonadapter(this);
        recycle.setAdapter(searchpersonadapter);*/
    }
}