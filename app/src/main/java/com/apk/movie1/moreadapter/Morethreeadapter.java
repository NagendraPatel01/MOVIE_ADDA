...
public class Morethreeadapter  extends RecyclerView.Adapter<Morethreeadapter.MoreviewHolder> {

    Context context;
    List<Searchtvshowmodel>list;

    public Morethreeadapter(Context context, List<Searchtvshowmodel> list) {
